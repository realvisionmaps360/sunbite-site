...
const en = {
  ...
  findUs: {
    ...
    openingEyebrow: 'Grand Opening',
    openingBody:    'Be there for our very first evening — fresh strawberries, Swiss chocolate, and summer vibes by the Aare.',
...
const de: typeof en = {
  ...
  findUs: {
    ...
    openingEyebrow: 'Grosse Eröffnung',
    openingBody:    'Feiere mit uns unseren allerersten Abend — frische Erdbeeren, Schweizer Schokolade und Sommerstimmung an der Aare.',
